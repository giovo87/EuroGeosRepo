...
public class ForestServlet extends HttpServlet {
    ...
    public ForestServlet() {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            response.getWriter().println("<h1>Hello ForestServlet!!! I'm OK!!!</h1>");
            response.getWriter().println("Parameters=" + request.getParameter("year"));
            response.getWriter().println("Parameters=" + request.getParameter("forest"));
            response.getWriter().println("Parameters=" + request.getParameter("owl"));
            response.getWriter().println("Parameters=" + request.getParameter("ol"));
            response.getWriter().println("Parameters=" + request.getParameter("otc"));
            response.getWriter().println("Parameters=" + request.getParameter("iwb"));
